  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh]">
      ...
      <div className="w-full space-y-3 mb-6">
        ...
        {isLoggedIn && (
          <p className="text-white font-medium text-lg text-center mb-1">Welcome back, {userName} &#128075;</p>
        )}

        {/* Go to Tracker — only if already logged in */}
        {isLoggedIn && (
          <button
        ...
        {/* Login with Gmail — always visible UNLESS logged in via Google */}
        {!isGoogleUser && (
          <button
          ...
          >
            ...
            {isLoggedIn ? "Upgrade to Gmail login" : "Login with Gmail"}
          </button>
        )}

        {/* Try as guest — only if NOT logged in at all */}
        {!isLoggedIn && (
          <button
            onClick={handleGuest}
